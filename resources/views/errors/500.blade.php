...
<head>
    ...
    <title>Server Error - VIP Earner GH</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-wrapper {
            position: fixed;
            inset: 0;
            background: linear-gradient(135deg, #0F172A 0%, #7F1D1D 30%, #991B1B 50%, #DC2626 70%, #F59E0B 100%);
        ...
        .orb-2 { width: 300px; height: 300px; background: #DC2626; bottom: -80px; left: -80px; animation: orbFloat 10s ease-in-out infinite reverse; }
        .orb-3 { width: 200px; height: 200px; background: #F87171; top: 40%; left: 10%; animation: orbFloat 6s ease-in-out infinite 2s; }
        @keyframes orbFloat {
        ...
        <div class="card">
            ...
            <div class="logo-wrapper">
                <svg class="logo-icon" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M50 15L56 31H73L60 42L65 59L50 48L35 59L40 42L27 31H44L50 15Z" fill="#0F172A"/>
                    <circle cx="50" cy="50" r="44" stroke="rgba(15,23,42,0.3)" stroke-width="4" stroke-dasharray="8 4"/>
                    <path d="M50 30L56 46H73L60 57L65 74L50 63L35 74L40 57L27 46H44L50 30Z" fill="rgba(15,23,42,0.2)"/>
                    <circle cx="50" cy="50" r="44" stroke="rgba(15,23,42,0.15)" stroke-width="2"/>
                </svg>
            </div>
            ...
            <p class="error-message">
                Something went wrong on our server. Our technical team has been automatically notified and is actively working to resolve this issue. We sincerely apologize for the inconvenience caused.
            </p>
            ...
            <div class="alert-box">
                ...
                <p>We apologize for this inconvenience.<br>Our team is working on it right now.</p>
            </div>
            ...
            <p class="footer-text">
                If this problem persists, please contact us at<br>
                <a href="mailto:support@vipearnergh.com">support@vipearnergh.com</a>
            </p>
        </div>
    </div>
